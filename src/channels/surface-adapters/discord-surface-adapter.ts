// v0.95 DiscordSurfaceAdapter
// Lightweight stub: supports emoji and markdown. Delegates ViewModel rendering to plain.
...
export class DiscordSurfaceAdapter implements SurfaceAdapter {
