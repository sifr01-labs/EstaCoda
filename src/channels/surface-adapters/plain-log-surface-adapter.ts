// v0.95 PlainLogSurfaceAdapter
// CI/log-safe output: no ANSI, no emoji, no HTML, no markdown.
...
export class PlainLogSurfaceAdapter implements SurfaceAdapter {
  readonly kind = "plain-log" as const;
