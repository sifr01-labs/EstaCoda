...
Himalaya supports raw password fields, but this skill should not generate them
unless the user explicitly requests a throwaway local test config. Do not commit
or print config files containing raw passwords. Prefer `auth.cmd` or
keyring-backed credentials for normal use.
