...
{
  "name": "product-design",
  "description": "Author, review, and optionally lint DESIGN.md product specs for AI-assisted software planning.",
  "version": "1.0.0",
  "category": "planning",
  "platforms": [
    "linux",
  ...
  "playbook": [
    {
      "id": "gather-context",
      "description": "Identify product goal, users, constraints, and decisions already made.",
      "toolsets": [
        "core",
        "files"
      ]
    ...
    {
      "id": "draft-product-design",
      "description": "Create or revise DESIGN.md using the starter template as needed.",
      "toolsets": [
        "files"
      ]
    },
    {
      "id": "optional-validate",
      "description": "Run optional lint/export tooling only when available and appropriate.",
      "toolsets": [
        "shell-readonly"
      ],
      "fallbackTo": [
  ...
  "evaluations": [
    {
      "input": "Create a DESIGN.md for a local-first notes app.",
      "shouldUseToolsets": [
        "files"
      ],
...
For purely visual inspiration or layout examples, use user-provided references, product screenshots, or web research when available.
...
`ui-design`. This skill is for the *formal spec file* itself.
...
1. **Ask the user** (or infer) the brand tone, accent color, and typography
   ...
   token shape above.
2. **Write `DESIGN.md`** in their project root using `file.write`. Always
...
# Optional, only when the user approves network/tool execution and the package is available
npx -y @google/design.md lint DESIGN.md

# Compare two versions, fail on regression (exit 1 = regression)
# Optional, only when the package is available
