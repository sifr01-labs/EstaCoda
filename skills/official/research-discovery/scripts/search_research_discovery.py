...
Usage:
    python search_research-discovery.py "GRPO reinforcement learning"
    python search_research-discovery.py "GRPO reinforcement learning" --max 10
    python search_research-discovery.py "GRPO reinforcement learning" --sort date
    python search_research-discovery.py --author "Yann LeCun" --max 5
    python search_research-discovery.py --category cs.AI --sort date --max 10
    python search_research-discovery.py --id 2402.03300
    python search_research-discovery.py --id 2402.03300,2401.12345
"""
import sys
...
def search(query=None, author=None, category=None, ids=None, max_results=5, sort="relevance"):
    ...
    req = urllib.request.Request(url, headers={'User-Agent': 'EstaCoda/1.0'})
