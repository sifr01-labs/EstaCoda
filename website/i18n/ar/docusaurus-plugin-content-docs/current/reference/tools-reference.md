...
**النماذج المحمية:** تجمع `browser.fill_protected_form` من مرجع واحد إلى ثمانية مراجع حالية من المراجعة وعلامة التبويب والإطار والأصل نفسها. تتحقق EstaCoda من كل الحقول قبل الجمع ومرة أخرى قبل التسليم، وتعرض مسار إدخال واحدًا متصلًا للمشغّل، ولا تعيد القيم المحمية إلى النموذج، ولا ترسل النموذج. تكون معرّفات الحساب وكلمات المرور وتحديات رمز الاستخدام لمرة واحدة اللاحقة طلبات منفصلة محددة النوع. ويمكن لطلب `browser.type` الخاص برمز الاستخدام لمرة واحدة أن يتضمن `submitRef` من المراجعة نفسها؛ يربط وقت التشغيل المحلي الحقل وزر الإرسال قبل مطالبة المستخدم، ثم يُدخل الرمز ويرسله من دون جولة إضافية للنموذج، ويعيد إيصال تسوية منقحًا فقط. لا يُعد الإرسال وحده دليلاً على نجاح المصادقة.
