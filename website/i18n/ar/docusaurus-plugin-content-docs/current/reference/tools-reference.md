...
في العمل الذي يمتد بين أنظمة متعددة، يمكن لعملية `write` تضمين `requirements` دلالية محدودة ومرتبطة بعناصر الخطة وبأسماء الأدوات الدقيقة المتاحة في الجلسة. يستمد وقت التشغيل تصنيف المخاطر ومسارات الإدخال المحمي التي تمت مراجعتها والتسليم المجمع والنقل من المتصفح وعلاقات التحقق المستقل من سجل الأدوات، ثم يتحقق منها وفق السجل النهائي والمصفّى للجلسة. نتائج الجاهزية المحلولة يكتبها وقت التشغيل فقط؛ ولا يستطيع إدخال المزوّد تحديد المسارات الأمنية أو تجاوز تصنيف المخاطر أو إعلان الجاهزية. إذا غابت قدرة إلزامية أو كانت غير متوافقة، تتوقف خطة التنفيذ قبل بدء العمل الفعلي على نظام المصدر؛ ولا يشغّل هذا الفحص أداة الوجهة ولا يمنح موافقة ولا يثبت صلاحيات الحساب البعيد.
