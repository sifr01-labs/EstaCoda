...
**النماذج المحمية:** تجمع `browser.fill_protected_form` من مرجع واحد إلى ثمانية مراجع حالية من الهوية القانونية وعلامة التبويب والإطار والأصل نفسها. تتحقق EstaCoda من كل الحقول قبل الجمع ومرة أخرى قبل التسليم، وتعرض مسار إدخال واحدًا متصلًا للمشغّل، ولا تعيد القيم المحمية إلى النموذج. عند توفير `submitRef`، يرسل وقت التشغيل المحلي عنصر المصادقة المربوط مسبقًا ضمن المعاملة نفسها. ويمكن لطلب `browser.type` الخاص برمز الاستخدام لمرة واحدة استخدام مسار الإرسال نفسه المرتبط بالهوية. لا يُعد الإرسال وحده دليلاً على نجاح المصادقة.
