...
**السلوك:** ينشئ رسم Task ثابتًا ودائمًا داخل معاملة واحدة ويعيد مقبضه فورًا. تتحول المهمة الواحدة إلى Step واحدة، وتتحول الدفعة إلى Steps مستقلة تحت Task واحدة. تمنع هوية استدعاء أداة المزوّد تكرار الإنشاء. لا يبقى تنفيذ متزامن للعامل ولا fallback للتخزين داخل الذاكرة.
