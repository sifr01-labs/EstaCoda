...
في العمل الذي يمتد بين أنظمة متعددة، يمكن لعملية `write` تضمين `requirements` محدودة ومرتبطة بعناصر الخطة وبأسماء الأدوات الدقيقة المتاحة في الجلسة. يتحقق وقت التشغيل من قدرات القراءة والتعديل والتحقق المستقل ومسارات الإدخال المحمي والنقل المحمي من المتصفح وفق سجل الأدوات النهائي والمصفّى للجلسة. نتائج الجاهزية يكتبها وقت التشغيل فقط. إذا غابت قدرة إلزامية أو كانت غير متوافقة، تتوقف خطة التنفيذ قبل بدء العمل الفعلي على نظام المصدر؛ ولا يشغّل هذا الفحص أداة الوجهة ولا يمنح موافقة ولا يثبت صلاحيات الحساب البعيد.
