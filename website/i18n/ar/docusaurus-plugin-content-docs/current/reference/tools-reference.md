...
يعرض `task.status` حالة Task محدودة، وتقدم Steps، وعدد Attempts النشطة، واكتمال الاستخدام والتسعير، وبيانات نتائج مبهمة. ولا يكشف مسارات workspace أو المطالبات أو مدخلات الأدوات أو بيانات الاعتماد أو أجسام النتائج الكاملة أو رسائل الفشل الخام. تعيد المعرّفات المفقودة وغير المصرح بها الخطأ نفسه.
