...
**السلوك:** تقرأ سجلات استخدام المزوّد المعتمدة للنطاق `scope: "session"` أو `scope: "latest_turn"`. لا تستدعي نموذجًا. يستبعد فحص أحدث دور الدور الحالي الذي استدعى الأداة، ويقسم الاستخدام إلى الوكيل الرئيسي والنماذج المساعدة والعمل المفوض، ويعرض النتيجة كمؤقتة ما دام عمل Task المرتبط نشطًا. استخدم `task.status` عندما يسمي المستخدم Task محددة. وقد يكون استخدام Task مشمولًا بالفعل في إجمالي الدور والجلسة اللذين نشأت منهما.
