...
تقاعدت مجموعة أوامر `estacoda workflow ...` بعد الانتقال إلى تخزين المهام الدائمة. ينتهي كل أمر برمز غير صفري مع إرشاد واضح. أوامر تشغيل المهام غير متاحة في هذا الإصدار.
