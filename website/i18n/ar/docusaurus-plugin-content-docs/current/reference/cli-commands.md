...
**سلوك أداة الاختيار:** في طرفية تفاعلية، يعرض `estacoda sessions` المجرّد ما يصل إلى 20 جلسة جذر قابلة للاستئناف وموجّهة للمستخدم من الملف التعريفي المختار ومساحة العمل الحالية. يعرض رقم الجلسة ووصفها، ويعرض للصف المحدد وقت البدء وآخر نشاط وسطح المنشأ. يستأنف Enter الجلسة عبر فحوص الإعداد وثقة مساحة العمل المعتادة. يبقى `sessions list` عرض المشغّل غير التفاعلي.
