...
توجد مهام إنهاء الجلسة أيضًا في `sessions.sqlite`. تخزن معرفات الملف الشخصي والجلسة، وحدًا ثابتًا للرسائل، والسبب، والحالة، والمحاولات، وleases، والطوابع الزمنية، وأكواد نتائج/أخطاء محدودة. لا تخزن نسخة من النص. تعالج البوابة المدارة المهام الخاصة بملفها الشخصي المحدد في الخلفية.
