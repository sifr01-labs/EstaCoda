...
عندما تطلب الصفحة عدة قيم محمية مترابطة، مثل البريد الإلكتروني وكلمة المرور، تستخدم EstaCoda مسار نموذج آمن واحدًا. تعرض كل وجهة متحققًا منها بالتتابع، وتُبقي القيم خارج سياق النموذج، ولا تملأ الحقول إلا بعد إعادة التحقق من النموذج كاملًا، وتترك زر تسجيل الدخول أو المتابعة لإجراء منفصل من الوكيل. إذا طلبت الصفحة لاحقًا رمز تحقق بخطوتين، تبدأ حالة الصفحة الجديدة مسارًا آمنًا ثانيًا. ولا يُحتسب وقت انتظار إدخالك للقيم المحمية من ميزانية وقت تشغيل المزوّد المستقل.
