...
بالنسبة إلى الصور، يعالج المسار الرئيسي الداعم للرؤية المرفقات الأولى مباشرة. يستخدم المسار الرئيسي النصي مسار `vision` المساعد، وتُمرر الصور المكتشفة لاحقًا بصورة مؤقتة عبر السياسة نفسها. يجب أن يكون كل مسار أساسي أو احتياطي قابلًا للتشغيل وداعمًا للرؤية. معالجة الصور المستضافة خروج سياقي للبيانات: لا تكرر الصور الصريحة في الجولة الحالية مطالبات الموافقة في الوضع التكيفي، بينما تطلب الملفات التي اكتشفها الوكيل موافقة، ويطلب الوضع الصارم موافقة، ويحظر `hostedProcessing: "local-only"` الإرسال المستضاف.
