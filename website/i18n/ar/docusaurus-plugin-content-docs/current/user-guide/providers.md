...
بالنسبة إلى الصور، يعالج المسار الرئيسي الداعم للرؤية المرفقات الأولى مباشرة. يستخدم المسار الرئيسي النصي مسار `vision` المساعد، وتُمرر الصور المكتشفة لاحقًا بصورة مؤقتة عبر السياسة نفسها. تشترك `vision.analyze` والمرفقات الأولى و`browser.vision` وآثار الصور المولّدة في مسار الإرسال المحكوم نفسه. تُحل مراجع `artifact://...` المولّدة داخل ذاكرة الصور المؤقتة للملف الشخصي المحدد من دون كشف مسار محلي مخفي. تبقى الأوصاف العادية على المسار الرئيسي متعدد الوسائط، بينما يتولى المسار المتخصص المهيأ صراحةً تحليلات OCR والمستندات والمخططات ولقطات الشاشة والمقارنة من صورتين إلى أربع صور. لا تستخدم المقارنة إلا المسارات الأساسية والاحتياطية القادرة على استقبال عدة صور. لا يضيف التوجيه التلقائي استدعاءً مساعدًا غير ضروري. يجب أن يملك كل مسار أساسي أو احتياطي محوّلًا مسجلًا وقابلًا للتنفيذ، وبيانات مزوّد قابلة للتشغيل، ودعمًا للرؤية. معالجة الصور المستضافة خروج سياقي للبيانات: لا تكرر المرفقات الحالية والمراجع الصريحة ولقطات المتصفح والآثار المولّدة مطالبات الموافقة في الوضع التكيفي؛ بينما تطلب الملفات التي اكتشفها الوكيل موافقة، ويطلب الوضع الصارم موافقة، ويحظر `hostedProcessing: "local-only"` الإرسال المستضاف. يشتق وقت التشغيل مصدر كل صورة في المقارنة، وتُرفض محاولات الاجتياز أو الهروب عبر الروابط الرمزية من ذاكرة الصور المؤقتة.
