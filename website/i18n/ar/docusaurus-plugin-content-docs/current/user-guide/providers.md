...
بالنسبة إلى الصور، يعالج المسار الرئيسي الداعم للرؤية المرفقات الأولى مباشرة. يستخدم المسار الرئيسي النصي مسار `vision` المساعد، وتُمرر الصور المكتشفة لاحقًا بصورة مؤقتة عبر السياسة نفسها. تبقى الأوصاف العادية على المسار الرئيسي متعدد الوسائط، بينما يتولى المسار المتخصص المهيأ صراحةً تحليلات OCR والمستندات والمخططات ولقطات الشاشة. لا يضيف التوجيه التلقائي استدعاءً مساعدًا غير ضروري. يجب أن يملك كل مسار أساسي أو احتياطي محوّلًا مسجلًا وقابلًا للتنفيذ، وبيانات مزوّد قابلة للتشغيل، ودعمًا للرؤية. معالجة الصور المستضافة خروج سياقي للبيانات: لا تكرر الصور الصريحة في الجولة الحالية مطالبات الموافقة في الوضع التكيفي، بينما تطلب الملفات التي اكتشفها الوكيل موافقة، ويطلب الوضع الصارم موافقة، ويحظر `hostedProcessing: "local-only"` الإرسال المستضاف.
