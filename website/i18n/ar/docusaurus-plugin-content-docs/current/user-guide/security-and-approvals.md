...
يمكن لإعداد قدرات Python المُدارة أن يستخدم موافقات البوابة أيضًا. عندما تحتاج مهارة محددة إلى قدرة مسجلة مطلوبة لكنها غير مثبتة، تستطيع Telegram وأسطح البوابة الأخرى أن تطلب من المشغّل الموافقة على تثبيت تلك القدرة. الموافقة تثبّت حزم القدرة المسجلة والمجموعات المحددة فقط، ثم تستأنف الطلب الأصلي. الرفض أو انتهاء الصلاحية يترك القدرة غير مثبتة.
