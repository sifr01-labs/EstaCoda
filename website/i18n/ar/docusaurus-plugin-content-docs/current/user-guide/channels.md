...
| تفاعل المعالجة المؤقت | `default-on` |
...
- يُضاف تفاعل 👨‍💻 مؤقت إلى أحدث رسالة أصلية للمستخدم بعد قبول الطلب، بدلًا من رسالة «جارٍ التفكير» الأولية
- تحاول EstaCoda إزالة التفاعل عند اكتمال الدور أو فشله أو مقاطعته؛ وإذا رفض Telegram التفاعل الأولي، تعود EstaCoda تلقائيًا إلى «جارٍ التفكير»
- يستمر تقدم الأدوات والنموذج الاحتياطي والتنبيهات والموافقات اللاحق في رسالة تقدم واحدة متطورة
