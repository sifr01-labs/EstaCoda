...
في Telegram، رُد على إجابة من EstaCoda بالأمر `/usage` لفحص تكلفة تلك الإجابة تحديدًا من دون استدعاء نموذج. ويمكنك أيضًا الرد بلغة طبيعية، مثل «كم كلّفت هذه؟»، ليستخدم الوكيل نطاق استخدام الدور المُجاب عليه للقراءة فقط. تربط EstaCoda كل أجزاء الإجابة النهائية، لذلك يعمل الرد على أي جزء منها. ويُقيّد الربط بالملف الشخصي والمحادثة والموضوع والجلسة؛ أما الرسائل غير المرتبطة أو غير المصرح بها فتُرفض افتراضيًا.
